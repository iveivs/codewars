...
const haystack = [2, 2, 1, 2, 1, 2, 3, 2]
const uniqueNumbers = new Set(haystack)
const newArr = Array.from(uniqueNumbers)
console.log(newArr);
// let lastResult
// // let newArr = [...haystack]
// while (lastResult !== -1) {
//     lastResult = uniqueNumbers.indexOf(2, lastResult + 1)
//     if (lastResult !== -1) {
//         uniqueNumbers.splice(lastResult, 1)
//     }
// }
